...
void loop()
{
  switch(screenState)
  {
    ...
    case HOME_SCREEN:
      ...
      AccelStepper_run(Stepper_1_Position, Stepper_2_Position);
...
void AccelStepper_run(int stepper_1_Pos, int stepper_2_Pos)
{
